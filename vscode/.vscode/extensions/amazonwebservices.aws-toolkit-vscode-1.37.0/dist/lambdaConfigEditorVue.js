(()=>{var Y={18:(e,o,i)=>{"use strict";i.r(o),i.d(o,{default:()=>$});var r=i(537),d=i.n(r),m=i(645),V=i.n(m),B=i(667),w=i.n(B),P=new URL(i(558),i.b),O=new URL(i(798),i.b),M=V()(d()),D=w()(P),g=w()(O);M.push([e.id,`
...
`],sourceRoot:""}]);const $=M},818:(e,o,i)=>{"use strict";i.r(o),i.d(o,{default:()=>w});var r=i(537),d=i.n(r),m=i(645),V=i.n(m),B=V()(d());B.push([e.id,`form[data-v-3cc26eec] {
    padding: 15px;
}
.section-header[data-v-3cc26eec] {
    margin: 0px;
    margin-bottom: 10px;
    display: flex;
    justify-content: flex-start;
}
textarea[data-v-3cc26eec] {
    max-width: 100%;
}
.config-item[data-v-3cc26eec] {
    border-bottom: 1px solid var(--vscode-menubar-selectionBackground);
    display: grid;
    grid-template-columns: 1fr 3fr;
    padding: 8px 0px;
}
.col2[data-v-3cc26eec] {
    grid-column: 2;
}
.data-view[data-v-3cc26eec] {
    display: none;
    border: dashed rgb(218, 31, 31) 1px;
    color: rgb(218, 31, 31);
}
#invoke-button-container[data-v-3cc26eec] {
    padding: 15px 15px;
    position: sticky;
    bottom: 20px;
    display: flex;
...
`)}return[i].join(`
`)}},744:(e,o)=>{"use strict";var i;i={value:!0},o.Z=(r,d)=>{for(const[m,V]of d)r[m]=V;return r}},138:(e,o,i)=>{var r=i(18);r.__esModule&&(r=r.default),typeof r=="string"&&(r=[[e.id,r,""]]),r.locals&&(e.exports=r.locals);var d=i(346).Z,m=d("6386bd73",r,!1,{})},93:(e,o,i)=>{var r=i(818);r.__esModule&&(r=r.default),typeof r=="string"&&(r=[[e.id,r,""]]),r.locals&&(e.exports=r.locals);var d=i(346).Z,m=d("edaba7c2",r,!1,{})},346:(e,o,i)=>{"use strict";i.d(o,{Z:()=>$});function r(s,h){for(var p=[],c={},l=0;l<h.length;l++){var I=h[l],C=I[0],L=I[1],T=I[2],J=I[3],S={id:s+":"+l,css:L,media:T,sourceMap:J};c[C]?c[C].parts.push(S):p.push(c[C]={id:C,parts:[S]})}return p}var d=typeof document!="undefined";if(typeof DEBUG!="undefined"&&DEBUG&&!d)throw new Error("vue-style-loader cannot be used in a non-browser environment. Use { target: 'node' } in your Webpack config to indicate a server-rendering environment.");var m={},V=d&&(document.head||document.getElementsByTagName("head")[0]),B=null,w=0,P=!1,O=function(){},M=null,D="data-vue-ssr-id",g=typeof navigator!="undefined"&&/msie [6-9]\b/.test(navigator.userAgent.toLowerCase());function $(s,h,p,c){P=p,M=c||{};var l=r(s,h);return j(l),function(C){for(var L=[],T=0;T<l.length;T++){var J=l[T],S=m[J.id];S.refs--,L.push(S)}C?(l=r(s,C),j(l)):l=[];for(var T=0;T<L.length;T++){var S=L[T];if(S.refs===0){for(var H=0;H<S.parts.length;H++)S.parts[H]();delete m[S.id]}}}}function j(s){for(var h=0;h<s.length;h++){var p=s[h],c=m[p.id];if(c){c.refs++;for(var l=0;l<c.parts.length;l++)c.parts[l](p.parts[l]);for(;l<p.parts.length;l++)c.parts.push(W(p.parts[l]));c.parts.length>p.parts.length&&(c.parts.length=p.parts.length)}else{for(var I=[],l=0;l<p.parts.length;l++)I.push(W(p.parts[l]));m[p.id]={id:p.id,refs:1,parts:I}}}}function x(){var s=document.createElement("style");return s.type="text/css",V.appendChild(s),s}function W(s){var h,p,c=document.querySelector("style["+D+'~="'+s.id+'"]');if(c){if(P)return O;c.parentNode.removeChild(c)}if(g){var l=w++;c=B||(B=x()),h=F.bind(null,c,l,!1),p=F.bind(null,c,l,!0)}else c=x(),h=G.bind(null,c),p=function(){c.parentNode.removeChild(c)};return h(s),function(C){if(C){if(C.css===s.css&&C.media===s.media&&C.sourceMap===s.sourceMap)return;h(s=C)}else p()}}var X=function(){var s=[];return function(h,p){return s[h]=p,s.filter(Boolean).join(`
`)}}();function F(s,h,p,c){var l=p?"":c.css;if(s.styleSheet)s.styleSheet.cssText=X(h,l);else{var I=document.createTextNode(l),C=s.childNodes;C[h]&&s.removeChild(C[h]),C.length?s.insertBefore(I,C[h]):s.appendChild(I)}}function G(s,h){var p=h.css,c=h.media,l=h.sourceMap;if(c&&s.setAttribute("media",c),M.ssrId&&s.setAttribute(D,h.id),l&&(p+=`
/*# sourceURL=`+l.sources[0]+" */",p+=`
/*# sourceMappingURL=data:application/json;base64,`+btoa(unescape(encodeURIComponent(JSON.stringify(l))))+" */"),s.styleSheet)s.styleSheet.cssText=p;else{for(;s.firstChild;)s.removeChild(s.firstChild);s.appendChild(document.createTextNode(p))}}},558:(e,o,i)=>{"use strict";e.exports=i.p+"cc7dacc55d3a9f3f983f.svg"},798:(e,o,i)=>{"use strict";e.exports=i.p+"44d827b5740d008688e0.svg"}},q={};function y(e){var o=q[e];if(o!==void 0)return o.exports;var i=q[e]={id:e,exports:{}};return Y[e](i,i.exports,y),i.exports}y.m=Y,y.n=e=>{var o=e&&e.__esModule?()=>e.default:()=>e;return y.d(o,{a:o}),o},y.d=(e,o)=>{for(var i in o)y.o(o,i)&&!y.o(e,i)&&Object.defineProperty(e,i,{enumerable:!0,get:o[i]})},y.g=function(){if(typeof globalThis=="object")return globalThis;try{return this||new Function("return this")()}catch(e){if(typeof window=="object")return window}}(),y.o=(e,o)=>Object.prototype.hasOwnProperty.call(e,o),y.r=e=>{typeof Symbol!="undefined"&&Symbol.toStringTag&&Object.defineProperty(e,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(e,"__esModule",{value:!0})},(()=>{var e;y.g.importScripts&&(e=y.g.location+"");var o=y.g.document;if(!e&&o&&(o.currentScript&&(e=o.currentScript.src),!e)){var i=o.getElementsByTagName("script");i.length&&(e=i[i.length-1].src)}if(!e)throw new Error("Automatic publicPath is not supported in this browser");e=e.replace(/#.*$/,"").replace(/\?.*$/,"").replace(/\/[^\/]+$/,"/"),y.p=e})(),(()=>{y.b=document.baseURI||self.location.href;var e={597:0}})();var Q={};(()=>{"use strict";y.r(Q);const e=Vue,o=t=>((0,e.pushScopeId)("data-v-3cc26eec"),t=t(),(0,e.popScopeId)(),t),i={class:"invoke-lambda-form"},r=o(()=>(0,e.createElementVNode)("h1",null,"SAM Debug Configuration Editor",-1)),d=o(()=>(0,e.createElementVNode)("label",{for:"target-type-selector"},"Invoke Target Type",-1)),m=["value"],V={class:"data-view"},B={key:0,class:"target-code"},w={class:"config-item"},P=o(()=>(0,e.createElementVNode)("label",{for:"select-directory"},"Project Root",-1)),O={class:"data-view"},M={class:"config-item"},D=o(()=>(0,e.createElementVNode)("label",{for:"lambda-handler"},"Lambda Handler",-1)),g={class:"data-view"},$={class:"config-item"},j=o(()=>(0,e.createElementVNode)("label",{for:"runtime-selector"},"Runtime",-1)),x=o(()=>(0,e.createElementVNode)("option",{disabled:""},"Choose a runtime...",-1)),W=["value"],X={class:"data-view"},F={key:1,class:"target-template"},G=o(()=>(0,e.createElementVNode)("br",null,null,-1)),s={class:"config-item"},h=o(()=>(0,e.createElementVNode)("label",{for:"template-path"},"Template Path",-1)),p={class:"data-view"},c={class:"config-item"},l=o(()=>(0,e.createElementVNode)("label",{for:"logicalID"},"Resource (Logical Id)",-1)),I={class:"data-view"},C={class:"config-item"},L=o(()=>(0,e.createElementVNode)("label",{for:"runtime-selector"},"Runtime",-1)),T=o(()=>(0,e.createElementVNode)("option",{disabled:""},"Choose a runtime...",-1)),J=["value"],S={class:"data-view"},H={key:2,class:"target-apigw"},de=o(()=>(0,e.createElementVNode)("br",null,null,-1)),ce={class:"config-item"},pe=o(()=>(0,e.createElementVNode)("label",{for:"template-path"},"Template Path",-1)),ue={class:"data-view"},me={class:"config-item"},ve=o(()=>(0,e.createElementVNode)("label",{for:"logicalID"},"Resource (Logical Id)",-1)),ge={class:"config-item"},he=o(()=>(0,e.createElementVNode)("label",{for:"runtime-selector"},"Runtime",-1)),fe=o(()=>(0,e.createElementVNode)("option",{disabled:""},"Choose a runtime...",-1)),_e=["value"],Ae={class:"data-view"},be={class:"config-item"},Ce=o(()=>(0,e.createElementVNode)("label",{for:"path"},"Path",-1)),ye={class:"config-item"},Ee=o(()=>(0,e.createElementVNode)("label",{for:"http-method-selector"},"HTTP Method",-1)),Ve=o(()=>(0,e.createElementVNode)("option",{disabled:""},"Choose an HTTP Method",-1)),Be=["value"],Ne={class:"data-view"},ke={class:"config-item"},we=o(()=>(0,e.createElementVNode)("label",{for:"query-string"},"Query String",-1)),Ie={class:"config-item"},Se=o(()=>(0,e.createElementVNode)("label",{for:"headers"},"Headers",-1)),Te=["data-invalid"],Me={key:0,class:"input-validation col2"},De={key:3},Pe=o(()=>(0,e.createElementVNode)("h3",null,"aws",-1)),Oe={class:"config-item"},Le=o(()=>(0,e.createElementVNode)("label",{for:"awsConnection"},"Credentials:",-1)),Ue={class:"config-item"},Re=o(()=>(0,e.createElementVNode)("label",{for:"region"},"Region",-1)),$e=o(()=>(0,e.createElementVNode)("h3",null,"lambda",-1)),Je={class:"config-item"},He=o(()=>(0,e.createElementVNode)("label",{for:""},"Environment Variables",-1)),je=["data-invalid"],xe={key:0,class:"input-validation col2"},We={class:"config-item"},Fe=o(()=>(0,e.createElementVNode)("label",{for:"memory"},"Memory (MB)",-1)),ze={class:"config-item"},Ke=o(()=>(0,e.createElementVNode)("label",{for:"timeoutSec"},"Timeout (s)",-1)),Ze=o(()=>(0,e.createElementVNode)("h3",null,"sam",-1)),Xe={class:"config-item"},Ge=o(()=>(0,e.createElementVNode)("label",{for:"buildArguments"},"Build Arguments",-1)),Ye={class:"config-item"},qe=o(()=>(0,e.createElementVNode)("label",{for:"containerBuild"},"Container Build",-1)),Qe={class:"config-item"},et=o(()=>(0,e.createElementVNode)("label",{for:"dockerNetwork"},"Docker Network",-1)),tt={class:"config-item"},nt=o(()=>(0,e.createElementVNode)("label",{for:"localArguments"},"Local Arguments",-1)),at={class:"config-item"},ot=o(()=>(0,e.createElementVNode)("label",{for:"skipNewImageCheck"},"Skip New Image Check",-1)),it={class:"config-item"},st=o(()=>(0,e.createElementVNode)("label",{for:"templateParameters"},"Template - Parameters",-1)),rt=["data-invalid"],lt={key:0,class:"input-validation col2"},dt=o(()=>(0,e.createElementVNode)("h3",null,"api",-1)),ct={class:"config-item"},pt=o(()=>(0,e.createElementVNode)("label",{for:"querystring"},"Query String",-1)),ut={class:"config-item"},mt=o(()=>(0,e.createElementVNode)("label",{for:"stageVariables"},"Stage Variables",-1)),vt=["data-invalid"],gt={key:0,class:"input-validation col2"},ht={class:"config-item"},ft=o(()=>(0,e.createElementVNode)("label",{for:"clientCerificateId"},"Client Certificate ID",-1)),_t={class:"config-item"},At=o(()=>(0,e.createElementVNode)("label",{for:"apiPayload"},"API Payload",-1)),bt=["data-invalid"],Ct={key:0,class:"input-validation col2"},yt=o(()=>(0,e.createElementVNode)("br",null,null,-1)),Et={class:"data-view"},Vt={key:0,class:"input-validation"},Bt={class:"container",id:"invoke-button-container"};function Nt(t,n,u,f,b,A){const _=(0,e.resolveComponent)("settings-panel");return(0,e.openBlock)(),(0,e.createElementBlock)("form",i,[r,(0,e.createVNode)(_,{id:"config-panel",title:"Configuration",description:""},{default:(0,e.withCtx)(()=>[d,(0,e.withDirectives)((0,e.createElementVNode)("select",{name:"target-types",id:"target-type-selector","onUpdate:modelValue":n[0]||(n[0]=a=>t.launchConfig.invokeTarget.target=a)},[((0,e.openBlock)(!0),(0,e.createElementBlock)(e.Fragment,null,(0,e.renderList)(t.targetTypes,(a,v)=>((0,e.openBlock)(),(0,e.createElementBlock)("option",{value:a.value,key:v},(0,e.toDisplayString)(a.name),9,m))),128))],512),[[e.vModelSelect,t.launchConfig.invokeTarget.target]]),(0,e.createElementVNode)("span",V,(0,e.toDisplayString)(t.launchConfig.invokeTarget.target),1),t.launchConfig.invokeTarget.target==="code"?((0,e.openBlock)(),(0,e.createElementBlock)("div",B,[(0,e.createElementVNode)("div",w,[P,(0,e.withDirectives)((0,e.createElementVNode)("input",{id:"select-directory",type:"text","onUpdate:modelValue":n[1]||(n[1]=a=>t.launchConfig.invokeTarget.projectRoot=a),placeholder:"Enter a directory"},null,512),[[e.vModelText,t.launchConfig.invokeTarget.projectRoot]]),(0,e.createElementVNode)("span",O,"the selected directory: "+(0,e.toDisplayString)(t.launchConfig.invokeTarget.projectRoot),1)]),(0,e.createElementVNode)("div",M,[D,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text",placeholder:"Enter the lambda handler",name:"lambda-handler",id:"lambda-handler","onUpdate:modelValue":n[2]||(n[2]=a=>t.launchConfig.invokeTarget.lambdaHandler=a)},null,512),[[e.vModelText,t.launchConfig.invokeTarget.lambdaHandler]]),(0,e.createElementVNode)("span",g,"lamda handler :"+(0,e.toDisplayString)(t.launchConfig.invokeTarget.lambdaHandler),1)]),(0,e.createElementVNode)("div",$,[j,(0,e.withDirectives)((0,e.createElementVNode)("select",{name:"runtimeType","onUpdate:modelValue":n[3]||(n[3]=a=>t.launchConfig.lambda.runtime=a)},[x,((0,e.openBlock)(!0),(0,e.createElementBlock)(e.Fragment,null,(0,e.renderList)(t.runtimes,(a,v)=>((0,e.openBlock)(),(0,e.createElementBlock)("option",{value:a,key:v},(0,e.toDisplayString)(a),9,W))),128))],512),[[e.vModelSelect,t.launchConfig.lambda.runtime]]),(0,e.createElementVNode)("span",X,"runtime in data: "+(0,e.toDisplayString)(t.launchConfig.lambda.runtime),1)])])):t.launchConfig.invokeTarget.target==="template"?((0,e.openBlock)(),(0,e.createElementBlock)("div",F,[(0,e.createElementVNode)("button",{class:"margin-bottom-16",onClick:n[4]||(n[4]=(0,e.withModifiers)((...a)=>t.loadResource&&t.loadResource(...a),["prevent"]))},"Load Resource"),G,(0,e.createElementVNode)("div",s,[h,(0,e.withDirectives)((0,e.createElementVNode)("input",{id:"template-path-button",type:"text","onUpdate:modelValue":n[5]||(n[5]=a=>t.launchConfig.invokeTarget.templatePath=a),placeholder:"Enter the template path..."},null,512),[[e.vModelText,t.launchConfig.invokeTarget.templatePath]]),(0,e.createElementVNode)("span",p,"Template path from data: "+(0,e.toDisplayString)(t.launchConfig.invokeTarget.templatePath),1)]),(0,e.createElementVNode)("div",c,[l,(0,e.withDirectives)((0,e.createElementVNode)("input",{name:"template-logical-id",id:"template-logical-id",type:"text",placeholder:"Enter a resource","onUpdate:modelValue":n[6]||(n[6]=a=>t.launchConfig.invokeTarget.logicalId=a)},null,512),[[e.vModelText,t.launchConfig.invokeTarget.logicalId]]),(0,e.createElementVNode)("span",I," Logical Id from data: "+(0,e.toDisplayString)(t.launchConfig.invokeTarget.logicalId),1)]),(0,e.createElementVNode)("div",C,[L,(0,e.withDirectives)((0,e.createElementVNode)("select",{name:"runtimeType","onUpdate:modelValue":n[7]||(n[7]=a=>t.launchConfig.lambda.runtime=a)},[T,((0,e.openBlock)(!0),(0,e.createElementBlock)(e.Fragment,null,(0,e.renderList)(t.runtimes,(a,v)=>((0,e.openBlock)(),(0,e.createElementBlock)("option",{value:a,key:v},(0,e.toDisplayString)(a),9,J))),128))],512),[[e.vModelSelect,t.launchConfig.lambda.runtime]]),(0,e.createElementVNode)("span",S,"runtime in data: "+(0,e.toDisplayString)(t.launchConfig.lambda.runtime),1)])])):t.launchConfig.invokeTarget.target==="api"?((0,e.openBlock)(),(0,e.createElementBlock)("div",H,[(0,e.createElementVNode)("button",{onClick:n[8]||(n[8]=(0,e.withModifiers)((...a)=>t.loadResource&&t.loadResource(...a),["prevent"]))},"Load Resource"),de,(0,e.createElementVNode)("div",ce,[pe,(0,e.withDirectives)((0,e.createElementVNode)("input",{id:"template-path-button",type:"text","onUpdate:modelValue":n[9]||(n[9]=a=>t.launchConfig.invokeTarget.templatePath=a),placeholder:"Enter the template path..."},null,512),[[e.vModelText,t.launchConfig.invokeTarget.templatePath]]),(0,e.createElementVNode)("span",ue,"Template path from data: "+(0,e.toDisplayString)(t.launchConfig.invokeTarget.templatePath),1)]),(0,e.createElementVNode)("div",me,[ve,(0,e.withDirectives)((0,e.createElementVNode)("input",{name:"template-logical-id",id:"template-logical-id",type:"text",placeholder:"Enter a resource","onUpdate:modelValue":n[10]||(n[10]=a=>t.launchConfig.invokeTarget.logicalId=a)},null,512),[[e.vModelText,t.launchConfig.invokeTarget.logicalId]])]),(0,e.createElementVNode)("div",ge,[he,(0,e.withDirectives)((0,e.createElementVNode)("select",{name:"runtimeType","onUpdate:modelValue":n[11]||(n[11]=a=>t.launchConfig.lambda.runtime=a)},[fe,((0,e.openBlock)(!0),(0,e.createElementBlock)(e.Fragment,null,(0,e.renderList)(t.runtimes,(a,v)=>((0,e.openBlock)(),(0,e.createElementBlock)("option",{value:a,key:v},(0,e.toDisplayString)(a),9,_e))),128))],512),[[e.vModelSelect,t.launchConfig.lambda.runtime]]),(0,e.createElementVNode)("span",Ae,"runtime in data: "+(0,e.toDisplayString)(t.launchConfig.lambda.runtime),1)]),(0,e.createElementVNode)("div",be,[Ce,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[12]||(n[12]=a=>t.launchConfig.api.path=a)},null,512),[[e.vModelText,t.launchConfig.api.path]])]),(0,e.createElementVNode)("div",ye,[Ee,(0,e.withDirectives)((0,e.createElementVNode)("select",{name:"http-method","onUpdate:modelValue":n[13]||(n[13]=a=>t.launchConfig.api.httpMethod=a)},[Ve,((0,e.openBlock)(!0),(0,e.createElementBlock)(e.Fragment,null,(0,e.renderList)(t.httpMethods,(a,v)=>((0,e.openBlock)(),(0,e.createElementBlock)("option",{value:a.toLowerCase(),key:v},(0,e.toDisplayString)(a),9,Be))),128))],512),[[e.vModelSelect,t.launchConfig.api.httpMethod]]),(0,e.createElementVNode)("span",Ne,(0,e.toDisplayString)(t.launchConfig.api.httpMethod),1)]),(0,e.createElementVNode)("div",ke,[we,(0,e.withDirectives)((0,e.createElementVNode)("input",{name:"query-string",id:"query-string",type:"text",cols:"15",rows:"2",placeholder:"Enter a query","onUpdate:modelValue":n[14]||(n[14]=a=>t.launchConfig.api.querystring=a)},null,512),[[e.vModelText,t.launchConfig.api.querystring]])]),(0,e.createElementVNode)("div",Ie,[Se,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[15]||(n[15]=a=>t.headers.value=a),placeholder:"Enter as valid JSON","data-invalid":!!t.headers.errorMsg},null,8,Te),[[e.vModelText,t.headers.value]]),t.headers.errorMsg?((0,e.openBlock)(),(0,e.createElementBlock)("div",Me," Error parsing JSON: "+(0,e.toDisplayString)(t.headers.errorMsg),1)):(0,e.createCommentVNode)("v-if",!0)])])):((0,e.openBlock)(),(0,e.createElementBlock)("div",De,"Select an Invoke Target"))]),_:1}),(0,e.createVNode)(_,{id:"more-fields-panel",title:"Additional Fields",description:"","start-collapsed":""},{default:(0,e.withCtx)(()=>[Pe,(0,e.createElementVNode)("div",Oe,[Le,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[16]||(n[16]=a=>t.launchConfig.aws.credentials=a)},null,512),[[e.vModelText,t.launchConfig.aws.credentials]])]),(0,e.createElementVNode)("div",Ue,[Re,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[17]||(n[17]=a=>t.launchConfig.aws.region=a)},null,512),[[e.vModelText,t.launchConfig.aws.region]])]),$e,(0,e.createElementVNode)("div",Je,[He,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text",placeholder:"Enter as valid JSON","onUpdate:modelValue":n[18]||(n[18]=a=>t.environmentVariables.value=a),"data-invalid":!!t.environmentVariables.errorMsg},null,8,je),[[e.vModelText,t.environmentVariables.value]]),t.environmentVariables.errorMsg?((0,e.openBlock)(),(0,e.createElementBlock)("div",xe," Error parsing JSON: "+(0,e.toDisplayString)(t.environmentVariables.errorMsg),1)):(0,e.createCommentVNode)("v-if",!0)]),(0,e.createElementVNode)("div",We,[Fe,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"number","onUpdate:modelValue":n[19]||(n[19]=a=>t.launchConfig.lambda.memoryMb=a)},null,512),[[e.vModelText,t.launchConfig.lambda.memoryMb,void 0,{number:!0}]])]),(0,e.createElementVNode)("div",ze,[Ke,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"number","onUpdate:modelValue":n[20]||(n[20]=a=>t.launchConfig.lambda.timeoutSec=a)},null,512),[[e.vModelText,t.launchConfig.lambda.timeoutSec,void 0,{number:!0}]])]),(0,e.createCommentVNode)(` <div class="config-item">
                <label for="pathMappings">Path Mappings</label>
                <input type="text" v-model="launchConfig.lambda.pathMappings" >
            </div> `),Ze,(0,e.createElementVNode)("div",Xe,[Ge,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[21]||(n[21]=a=>t.launchConfig.sam.buildArguments=a),placeholder:"Enter as a comma separated list"},null,512),[[e.vModelText,t.launchConfig.sam.buildArguments]])]),(0,e.createElementVNode)("div",Ye,[qe,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"checkbox",name:"containerBuild",id:"containerBuild","onUpdate:modelValue":n[22]||(n[22]=a=>t.containerBuild=a)},null,512),[[e.vModelCheckbox,t.containerBuild]])]),(0,e.createElementVNode)("div",Qe,[et,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[23]||(n[23]=a=>t.launchConfig.sam.dockerNetwork=a)},null,512),[[e.vModelText,t.launchConfig.sam.dockerNetwork]])]),(0,e.createElementVNode)("div",tt,[nt,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[24]||(n[24]=a=>t.launchConfig.sam.localArguments=a),placeholder:"Enter as a comma separated list"},null,512),[[e.vModelText,t.launchConfig.sam.localArguments]])]),(0,e.createElementVNode)("div",at,[ot,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"checkbox",name:"skipNewImageCheck",id:"skipNewImageCheck","onUpdate:modelValue":n[25]||(n[25]=a=>t.skipNewImageCheck=a)},null,512),[[e.vModelCheckbox,t.skipNewImageCheck]])]),(0,e.createElementVNode)("div",it,[st,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[26]||(n[26]=a=>t.parameters.value=a),"data-invalid":!!t.parameters.errorMsg},null,8,rt),[[e.vModelText,t.parameters.value]]),t.parameters.errorMsg?((0,e.openBlock)(),(0,e.createElementBlock)("div",lt," Error parsing JSON: "+(0,e.toDisplayString)(t.parameters.errorMsg),1)):(0,e.createCommentVNode)("v-if",!0)]),dt,(0,e.createElementVNode)("div",ct,[pt,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[27]||(n[27]=a=>t.launchConfig.api.querystring=a)},null,512),[[e.vModelText,t.launchConfig.api.querystring]])]),(0,e.createElementVNode)("div",ut,[mt,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[28]||(n[28]=a=>t.stageVariables.value=a),"data-invalid":!!t.stageVariables.errorMsg,placeholder:"Enter as valid JSON"},null,8,vt),[[e.vModelText,t.stageVariables.value]]),t.stageVariables.errorMsg?((0,e.openBlock)(),(0,e.createElementBlock)("div",gt," Error parsing JSON: "+(0,e.toDisplayString)(t.stageVariables.errorMsg),1)):(0,e.createCommentVNode)("v-if",!0)]),(0,e.createElementVNode)("div",ht,[ft,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[29]||(n[29]=a=>t.launchConfig.api.clientCertificateId=a)},null,512),[[e.vModelText,t.launchConfig.api.clientCertificateId]])]),(0,e.createElementVNode)("div",_t,[At,(0,e.withDirectives)((0,e.createElementVNode)("input",{type:"text","onUpdate:modelValue":n[30]||(n[30]=a=>t.apiPayload.value=a),placeholder:"Enter as valid JSON","data-invalid":!!t.apiPayload.errorMsg},null,8,bt),[[e.vModelText,t.apiPayload.value]]),t.apiPayload.errorMsg?((0,e.openBlock)(),(0,e.createElementBlock)("div",Ct," Error parsing JSON: "+(0,e.toDisplayString)(t.apiPayload.errorMsg),1)):(0,e.createCommentVNode)("v-if",!0)])]),_:1}),(0,e.createVNode)(_,{id:"payload-panel",title:"Payload",description:"","start-collapsed":""},{default:(0,e.withCtx)(()=>[(0,e.createElementVNode)("button",{class:"margin-bottom-16",onClick:n[31]||(n[31]=(0,e.withModifiers)((...a)=>t.loadPayload&&t.loadPayload(...a),["prevent"]))},"Load Sample Payload"),yt,(0,e.withDirectives)((0,e.createElementVNode)("textarea",{name:"lambda-payload",id:"lambda-payload",cols:"60",rows:"5","onUpdate:modelValue":n[32]||(n[32]=a=>t.payload.value=a)},null,512),[[e.vModelText,t.payload.value]]),(0,e.createElementVNode)("span",Et,"payload from data: "+(0,e.toDisplayString)(t.payload),1),t.payload.errorMsg?((0,e.openBlock)(),(0,e.createElementBlock)("div",Vt,"Error parsing JSON: "+(0,e.toDisplayString)(t.payload.errorMsg),1)):(0,e.createCommentVNode)("v-if",!0)]),_:1}),(0,e.createElementVNode)("div",Bt,[(0,e.createElementVNode)("button",{class:"",onClick:n[33]||(n[33]=(0,e.withModifiers)((...a)=>t.loadConfig&&t.loadConfig(...a),["prevent"]))},"Load Existing Config"),(0,e.createElementVNode)("button",{class:"form-buttons",onClick:n[34]||(n[34]=(0,e.withModifiers)((...a)=>t.launch&&t.launch(...a),["prevent"]))},"Invoke"),(0,e.createElementVNode)("button",{class:"form-buttons",onClick:n[35]||(n[35]=(0,e.withModifiers)((...a)=>t.save&&t.save(...a),["prevent"]))},"Save")])])}const $t=t=>(_pushScopeId("data-v-3e78b3d8"),t=t(),_popScopeId(),t),kt=["id"],wt={class:"header"},It=["id"],St=["for"],Tt={class:"settings-title"},Mt={class:"soft no-spacing"},Dt={ref:"subPane",class:"sub-pane"};function Pt(t,n,u,f,b,A){return(0,e.openBlock)(),(0,e.createElementBlock)("div",{id:t.id,class:"settings-panel"},[(0,e.createElementVNode)("div",wt,[t.collapseable||t.startCollapsed?(0,e.withDirectives)(((0,e.openBlock)(),(0,e.createElementBlock)("input",{key:0,ref:"button",id:t.buttonId,class:"preload-transition collapse-button",type:"checkbox","onUpdate:modelValue":n[0]||(n[0]=_=>t.collapsed=_)},null,8,It)),[[e.vModelCheckbox,t.collapsed]]):(0,e.createCommentVNode)("v-if",!0),(0,e.createElementVNode)("label",{for:t.buttonId},[(0,e.createElementVNode)("p",Tt,(0,e.toDisplayString)(t.title),1),(0,e.createElementVNode)("p",Mt,(0,e.toDisplayString)(t.description),1)],8,St)]),(0,e.createVNode)(e.Transition,{onEnter:t.updateHeight,onBeforeLeave:t.updateHeight,name:t.collapseable||t.startCollapsed?"collapse":""},{default:(0,e.withCtx)(()=>[(0,e.withDirectives)((0,e.createElementVNode)("div",Dt,[(0,e.renderSlot)(t.$slots,"default",{},void 0,!0)],512),[[e.vShow,!t.collapsed]])]),_:3},8,["onEnter","onBeforeLeave","name"])],8,kt)}/*!
 * Copyright 2021 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
 */const z=new Set;window.addEventListener("remount",()=>z.clear());const ee={created(){var t,n,u,f,b;if(this.$data===void 0)return;const A=(t=vscode.getState())!=null?t:{};this.$options._count=((n=this.$options._count)!=null?n:0)+1;const _=(f=this.id)!=null?f:`${(u=this.name)!=null?u:`DEFAULT-${z.size}`}-${this.$options._count}`;if(this.$options._unid=_,z.has(_)){console.warn(`Component "${_}" already exists. State-saving functionality will be disabled.`);return}z.add(_);const a=(b=A[_])!=null?b:{};Object.keys(this.$data).forEach(v=>{var N;this.$data[v]=(N=a[v])!=null?N:this.$data[v]}),Object.keys(this.$data).forEach(v=>{this.$watch(v,N=>{var E,k;const R=(E=vscode.getState())!=null?E:{},Z=Object.assign((k=R[_])!=null?k:{},{[v]:JSON.parse(JSON.stringify(N))});vscode.setState(Object.assign(R,{[_]:Z}))},{deep:!0})})}};let te=0;const Ot=(0,e.defineComponent)({name:"settings-panel",props:{id:String,startCollapsed:Boolean,collapseable:Boolean,title:String,description:String},data(){var t;return te+=1,{collapsed:(t=this.$props.startCollapsed)!=null?t:!1,buttonId:`settings-panel-button-${te}`,lastHeight:void 0}},mixins:[ee],methods:{updateHeight(t){t.style&&(this.lastHeight=t.scrollHeight,t.style.setProperty("--max-height",`${this.lastHeight}px`))}},mounted(){var t,n;this.subPane=this.$refs.subPane,this.lastHeight=this.collapsed?this.lastHeight:(n=(t=this.subPane)==null?void 0:t.scrollHeight)!=null?n:this.lastHeight,this.$nextTick(()=>{setTimeout(()=>{var u;(u=this.$refs.button)==null||u.classList.remove("preload-transition")},100)})}});var Ht=y(138),ne=y(744);const Lt=(0,ne.Z)(Ot,[["render",Pt],["__scopeId","data-v-3e78b3d8"]]);/*!
 * Copyright 2021 Amazon.com, Inc. or its affiliates. All Rights Reserved.
 * SPDX-License-Identifier: Apache-2.0
